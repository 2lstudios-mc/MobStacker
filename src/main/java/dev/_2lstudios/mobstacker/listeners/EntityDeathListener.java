...
public class EntityDeathListener implements Listener {
    ...
    public void onEntityDeath(EntityDeathEvent event) {
        ...
        if (entity instanceof Creature) {
            ...
            Stacked mob = stackedManager.getMob(creature);
            int count = mob.add(-1);
            ...
            if (count > 0) {
                ...
                Stacked mob1 = stackedManager.getMob(creature1);
                creature.setCustomName(null);

                if (count > 1) {
                    creature1.setCustomName(String.valueOf(ChatColor.YELLOW + "x" + count));
                }

                mob1.set(count);
            }

            stackedManager.removeMap(creature);
        }
    }
}
